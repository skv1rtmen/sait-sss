...
/* Etappe 12 · Regionseiten. Bewusst vorsichtig gehalten: sechs neue Städte innerhalb von rund
   30 Fahrminuten, jede mit eigenem Schwerpunkt und eigenem Bewilligungs-Hinweis. KEINE Matrix aus
   Stadt × Gewerk in Serie — 40 fast gleiche Seiten sind ein Doorway-Muster, das Google abstraft.
   Fahrzeiten sind gerundete Richtwerte ab Zürich-Altstetten, darum durchgehend «ca.». */
const KANTONE={ZH:"Zürich",AG:"Aargau",ZG:"Zug",LU:"Luzern"};
const REGION_SEO=[
 {slug:"winterthur",n:"Winterthur",kt:"ZH",zeit:"ca. 30 Min. ab unserem Standort Zürich-Altstetten",
  fokus:"Leerwohnungen und Objektbäder im Mehrfamilienhaus",
  ...
  svc:["renovation", "malerarbeiten", "sanitaer"],
  absatz:"Winterthur ist für uns Mehrfamilienhaus-Gebiet: der Auftrag heisst meist Leerwohnung oder Objektbad, nicht Einzelreparatur. Darum planen wir hier von hinten — vom Übergabetermin, den Sie der neuen Mieterschaft schon zugesagt haben, zurück auf den Tag, an dem die Schlüssel zu uns kommen. Maler, Böden und Sanitär laufen parallel statt nacheinander, und die Anfahrt von rund einer halben Stunde steckt im Festpreis, nicht in einer Extrazeile auf der Rechnung.",
  faq:[["Lohnt sich ein einzelnes Bad in Winterthur?","Ja, aber die Anfahrt rechnet sich besser, wenn wir mehrere Objekte bündeln. Bei einer Verwaltung mit mehreren Liegenschaften in Winterthur legen wir die Termine deshalb zusammen."],["Kommen Sie auch für eine Besichtigung vor der Offerte?","Ja, die Aufnahme vor Ort ist kostenlos und Bestandteil jeder Festpreis-Offerte — auch in Winterthur."]]},
 {slug:"zug",n:"Zug",kt:"ZG",zeit:"ca. 35 Min. ab unserem Standort Zürich-Altstetten",
  fokus:"Serienbäder und Objekte mit gehobenem Ausbaustandard",
  ...
  svc:["sanitaer", "fliesen-parkett", "renovation"],
  absatz:"Im Kanton Zug geht es bei unseren Aufträgen selten um die günstigste Variante, sondern um Ausbaustandard und Termintreue. Serienbäder sind der typische Fall: gleiche Materialien, gleicher Ablauf, Wohnung für Wohnung, damit jede Einheit einzeln wieder vermietbar wird statt alle gleichzeitig stillzustehen. Bewilligungen laufen hier nach Zuger Recht — die Abklärung mit der Gemeinde machen wir vor Baubeginn und halten sie schriftlich fest.",
  faq:[["Arbeiten Sie im Kanton Zug mit lokalen Behörden?","Wo eine Bewilligung nötig ist, klären wir sie mit der zuständigen Gemeinde ab, bevor wir anfangen. Das Ergebnis steht schriftlich in der Offerte."],["Können Sie mehrere Bäder gleichzeitig machen?","Wir arbeiten in Serie statt gleichzeitig: so ist immer nur eine Wohnung ausser Betrieb und die Qualität bleibt über alle Einheiten gleich."]]},
 {slug:"luzern",n:"Luzern",kt:"LU",zeit:"ca. 50 Min. ab unserem Standort Zürich-Altstetten",
  fokus:"gebündelte Einsätze statt einzelner Kleinaufträge",
  ...
  svc:["renovation", "neu-umbau", "malerarbeiten"],
  absatz:"Luzern liegt mit rund fünfzig Minuten am äusseren Rand unseres Gebiets. Das heisst nicht, dass wir nicht kommen — es heisst, dass wir anders planen: wir bündeln Einsätze, arbeiten in längeren Blöcken statt in vielen kurzen Besuchen, und für Verwaltungen mit mehreren Standorten ist ein Rahmenvertrag hier die sinnvollere Form als der Einzelauftrag. Für eine halbstündige Kleinreparatur sind wir in Luzern ehrlich gesagt der falsche Betrieb.",
  faq:[["Ist Luzern nicht zu weit weg?","Für Leerwohnungen, Bäder und Umbauten nicht — die Anfahrt ist im Festpreis. Für einzelne Kleinreparaturen unter drei Stunden empfehlen wir Ihnen einen Betrieb vor Ort."],["Wie oft sind Sie während der Arbeiten vor Ort?","Durchgehend. Wir arbeiten in Blöcken, nicht in Tagesbesuchen — das ist bei dieser Distanz für beide Seiten besser."]]},
 {slug:"baden",n:"Baden",kt:"AG",zeit:"ca. 20 Min. ab unserem Standort Zürich-Altstetten, durchgehend über die A1",
  fokus:"Portfolios, die über die Kantonsgrenze hinweg liegen",
  lead:"Renovation, Sanitär und Umbau in Baden und im unteren Limmattal. Für Verwaltungen mit Objekten beidseits der Kantonsgrenze: dieselbe Bauleitung für Aargau und Zürich, eine Abrechnung.",
  svc:["renovation", "sanitaer", "abbruch-rueckbau"],
  absatz:"Baden ist unser häufigster Fall über die Kantonsgrenze hinweg. Für eine Verwaltung, deren Portfolio sich über Aargau und Zürich verteilt, ist das der eigentliche Punkt: dieselbe Bauleitung, dieselben Konditionen und eine Abrechnung — statt je einem Betrieb pro Kanton. Was sich unterscheidet, ist die Bewilligungsseite: im Aargau gelten andere kantonale Vorgaben als im Kanton Zürich, und diese Abklärung übernehmen wir. Über die A1 sind wir in rund zwanzig Minuten da.",
  faq:[["Sind Sie im Aargau überhaupt zugelassen?","Ja. Wir sind im Handelsregister des Kantons Zürich eingetragen und betriebshaftpflichtversichert; für die Ausführung im Aargau ändert das nichts. Den Versicherungsnachweis legen wir auf Wunsch der Offerte bei."],["Können Sie Objekte in beiden Kantonen zusammen abrechnen?","Ja, das ist der Sinn eines Rahmenvertrags: gebündelt pro Monat oder pro Objekt, unabhängig von der Kantonsgrenze."]]},
 {slug:"dietikon",n:"Dietikon",kt:"ZH",zeit:"ca. 10 Min. ab unserem Standort Zürich-Altstetten",
  fokus:"kurze Wege — auch einzelne Reparaturen rechnen sich",
  lead:"Renovation, Sanitär und Umbau in Dietikon und im Limmattal. Die kürzeste Anfahrt in unserem Gebiet: hier lohnt sich auch der Einzeleinsatz ab drei Stunden, nicht erst die ganze Wohnung.",
  svc:["sanitaer", "malerarbeiten", "fliesen-parkett"],
  absatz:"Dietikon ist die kürzeste Anfahrt in unserem ganzen Gebiet — rund zehn Minuten vom Lager in Altstetten. Praktisch heisst das: hier rechnet sich auch der kleine Einsatz. Ein tropfender Anschluss, ein defekter Heizkörper, ein Zimmer streichen zwischen zwei Mietverhältnissen — Aufträge, für die sich eine Anfahrt nach Luzern nie lohnen würde, sind im Limmattal ab drei Stunden machbar. Material holen wir bei Bedarf zwischendurch, statt einen halben Tag dafür zu verlieren.",
  faq:[["Wie klein darf der Auftrag sein?","Ab drei Stunden. In Dietikon ist das realistisch, weil Anfahrt und Materialweg kurz sind."],["Wie schnell können Sie kommen?","Ohne Rahmenvertrag melden wir uns an Werktagen innert 24 Stunden mit einem Termin. Mit Rahmenvertrag gilt die dort vereinbarte Reaktionszeit."]]},
 {slug:"duebendorf",n:"Dübendorf",kt:"ZH",zeit:"ca. 20 Min. ab unserem Standort Zürich-Altstetten",
  fokus:"Gewerbe- und Büroflächen neben Wohnliegenschaften",
  lead:"Renovation, Sanitär und Umbau in Dübendorf und im Glattal — Wohnliegenschaften wie Gewerbe- und Büroflächen, auf Wunsch ausserhalb der Betriebszeiten.",
  svc:["neu-umbau", "renovation", "malerarbeiten"],
  absatz:"In Dübendorf und im Glattal stehen Wohnliegenschaften und Gewerbeflächen nebeneinander, und die beiden verlangen Verschiedenes. Bei der Wohnung zählt der Übergabetermin, bei der Büro- oder Ladenfläche zählt, dass der Betrieb nicht stillsteht. Deshalb arbeiten wir dort, wo nötig, in Etappen und ausserhalb der Betriebszeiten — Abend, Nacht oder Wochenende nach Absprache, mit täglicher Reinigung und Staubschutz, im Rahmen der örtlichen Lärmschutzvorschriften.",
  faq:[["Können Sie ausserhalb der Öffnungszeiten arbeiten?","Ja, nach Absprache. Lärmintensive Arbeiten legen wir in die erlaubten Zeitfenster; der Rest kann abends oder am Wochenende laufen."],["Machen Sie auch Elektroinstallationen im Gewerbe?","Die Vorbereitung — Schlitze, Leerrohre, Dosen — ja. Die Installation selbst führt ein konzessionierter Partnerbetrieb aus, den wir koordinieren."]]},
 {slug:"uster",n:"Uster",kt:"ZH",zeit:"ca. 25 Min. ab unserem Standort Zürich-Altstetten",
  fokus:"Mehrfamilienhäuser im Zürcher Oberland",
  lead:"Renovation, Sanitär und Umbau in Uster und im Zürcher Oberland — Leerwohnungen, Bäder und laufender Unterhalt, koordiniert von einer Bauleitung.",
  svc:["renovation", "sanitaer", "malerarbeiten"],
  absatz:"Uster und das Zürcher Oberland sind Mehrfamilienhaus-Gebiet mit vielen Objekten in Verwaltung. Der Auftrag, den wir hier am häufigsten bekommen, ist die Leerwohnung beim Mieterwechsel: Maler, Böden, Bad und Kleinreparaturen in einem Durchgang, mit einem Übergabetermin, den die Verwaltung der neuen Mieterschaft bereits zugesagt hat. Schlüssel nehmen wir per Protokoll entgegen — ein Termin mit der bisherigen Mieterschaft ist dafür nicht nötig.",
  faq:[["Brauchen Sie Zugang über den Mieter?","Nein. Bei einer leeren Wohnung übernehmen wir die Schlüssel per Protokoll und geben sie genauso zurück — mit Fotoprotokoll bei Übernahme und Rückgabe."],["Machen Sie auch den laufenden Unterhalt?","Ja — Sanitär, Boiler, Heizkörper, Kleinreparaturen. Reinigung, Gartenpflege und Winterdienst gehören nicht dazu."]]},
 {slug:"wetzikon",n:"Wetzikon",kt:"ZH",zeit:"ca. 30 Min. ab unserem Standort Zürich-Altstetten",
  fokus:"mehrere Standorte unter einem Rahmenvertrag",
  lead:"Renovation, Sanitär und Umbau in Wetzikon und im oberen Glattal. Für Verwaltungen mit verteilten Objekten: ein Rahmenvertrag, feste Konditionen, gebündelte Abrechnung.",
  svc:["renovation", "malerarbeiten", "fliesen-parkett"],
  absatz:"Wetzikon steht bei uns selten allein — meist gehört es zu einem Portfolio, das über das Oberland verteilt ist. Genau dafür ist der Rahmenvertrag gedacht: feste Regieansätze, Pauschalen für die immer gleichen Arbeiten, eine vereinbarte Reaktionszeit bei Störungen und eine Abrechnung pro Objekt oder gebündelt pro Monat. Einmal vereinbart, gilt er für jedes Objekt im Portfolio, egal ob in Wetzikon, Uster oder Zürich.",
  faq:[["Ab wie vielen Objekten lohnt sich ein Rahmenvertrag?","Das hängt weniger an der Zahl als an der Regelmässigkeit. Wer mehrmals im Jahr etwas zu vergeben hat, fährt mit festen Ansätzen besser als mit Einzelofferten."],["Wie schnell sind Sie bei einer Störung da?","Die Reaktionszeit wird im Rahmenvertrag vereinbart und hängt von Objektzahl und Region ab. Ohne Rahmenvertrag antworten wir an Werktagen innert 24 Stunden."]]},
 {slug:"horgen",n:"Horgen",kt:"ZH",zeit:"ca. 25 Min. ab unserem Standort Zürich-Altstetten",
  fokus:"Arbeiten im bewohnten Haus, mit Rücksicht auf die Nachbarschaft",
  lead:"Renovation, Sanitär und Umbau in Horgen und am linken Zürichseeufer. Meist wird im bewohnten Haus gearbeitet — Lärmzeiten angekündigt, Treppenhaus geschützt, Schutt täglich raus.",
  svc:["renovation", "sanitaer", "abbruch-rueckbau"],
  absatz:"Am linken Seeufer wird bei uns fast immer im bewohnten Haus gearbeitet — die Nachbarn bleiben während der ganzen Bauzeit da. Das verändert die Baustelle mehr als der Ort: Böden, Treppenhaus und Lift werden geschützt, bevor das erste Werkzeug ausgepackt wird, Lärmzeiten kündigen wir vorher an und informieren Mieterschaft und Nachbarn schriftlich, und Bauschutt verlässt die Baustelle täglich statt im Treppenhaus zu lagern.",
  faq:[["Was hören die Nachbarn davon?","Lärmintensive Arbeiten kündigen wir vorher schriftlich an und legen sie in die erlaubten Zeitfenster. Zugänge und Lift bleiben passierbar."],["Wo bleibt der Bauschutt?","Er geht täglich weg. Im Treppenhaus oder vor dem Haus lagert nichts über Nacht."]]},
];

/* Gewerk × Stadt: bewusst nur vier Seiten, und nur für die Badsanierung — der Suchbegriff mit der
   klarsten Kaufabsicht. Jede Seite trägt eigene Inhalte (Ablauf, Richtwert, Bewilligung, Referenz),
   nicht denselben Text mit getauschtem Ortsnamen. */
const GEWERK_SEO=[
 {slug:"badsanierung-zuerich",n:"Zürich",kt:"ZH",region:null,
  lead:"Komplette Badsanierung in der Stadt Zürich — Rückbau, neue Leitungen mit Druckprüfung, Abdichtung im Verbund, Platten und Montage. Ein Betrieb, ein Übergabetermin im Werkvertrag.",
  titel:"Baustelle Stadtwohnung",
  absatz:"In der Stadt Zürich entscheidet die Logistik über den Termin, nicht die Handwerksleistung. Vor dem Haus ist selten Platz für ein Fahrzeug, das Treppenhaus ist eng und wird von allen benutzt, und die alte Wanne muss denselben Weg zurück, den die neuen Platten hochkommen. Wir planen Anlieferung und Entsorgung deshalb vorher durch: Schutz auf Boden, Treppe und Lift, bevor etwas ausgepackt wird, und Schutt geht täglich raus statt sich im Gang zu stapeln. Für ein Bad in einem Altbau heisst das meistens: mehr Vorbereitung, gleicher Übergabetermin.",
  faq:[["Wo parkieren Ihre Fahrzeuge?","Wir klären Anlieferung und allfällige Bewilligungen vor Baubeginn mit Ihnen ab. Auf der Rechnung erscheint dafür keine eigene Position."],["Was ist bei einem Altbau anders?","Alte Leitungen und ungerade Wände kosten Zeit, nicht Überraschungen: was wir beim Aufmass sehen, steht in der Offerte. Zeigt sich hinter der Wand etwas Neues, melden wir es schriftlich, bevor wir weitermachen."]]},
 {slug:"badsanierung-winterthur",n:"Winterthur",kt:"ZH",region:"winterthur",
  lead:"Komplette Badsanierung in Winterthur — vom Rückbau bis zur Abnahme aus einer Hand, mit Prüfprotokoll für die Leitungen und 24 Monaten Werkgarantie.",
  titel:"Bad beim Mieterwechsel",
  absatz:"In Winterthur ist das Bad meist ein Teil der Instandstellung, nicht der einzige Auftrag — und damit hängt sein Termin am Übergabetermin der ganzen Wohnung. Wir legen die Badsanierung deshalb in den Takt der übrigen Gewerke: Rückbau, solange die Maler noch nicht da sind, Leitungen und Abdichtung vor den Böden, Montage zum Schluss. Für die Verwaltung bedeutet das einen Termin statt vier und eine Rechnung, die der Offerte Position für Position folgt.",
  faq:[["Läuft das zusammen mit Malerarbeiten und Böden?","Ja, das ist der Normalfall. Alle Gewerke kommen aus demselben Betrieb und werden von einer Bauleitung geplant."],["Reicht die Zeit zwischen zwei Mietverhältnissen?","Den verbindlichen Termin nennen wir nach dem Aufmass. Ist er zu knapp, sagen wir das vorher — nicht in der letzten Woche."]]},
 {slug:"badsanierung-zug",n:"Zug",kt:"ZG",region:"zug",
  lead:"Komplette Badsanierung im Kanton Zug — einzeln oder in Serie über mehrere Wohnungen, mit gleichen Materialien und gleichem Ablauf je Objekt.",
  titel:"Bäder in Serie",
  absatz:"Im Kanton Zug kommt die Badsanierung häufig gleich mehrfach: mehrere Wohnungen derselben Liegenschaft, gleicher Grundriss, gleicher Ausbaustandard. Wir machen sie nacheinander statt gleichzeitig — mit denselben Materialien und demselben Ablauf je Einheit. Dadurch ist immer nur eine Wohnung ausser Betrieb, jede wird einzeln wieder vermietbar, und der Aufwand pro Bad ist ab dem zweiten kalkulierbar statt geschätzt.",
  faq:[["Wie viele Bäder machen Sie hintereinander?","So viele wie nötig. Der Ablauf bleibt pro Einheit gleich; wir stimmen die Reihenfolge mit Ihren Mietverhältnissen ab."],["Wird es ab dem zweiten Bad günstiger?","Der Aufwand wird vor allem verlässlicher. Was sich wiederholt, können wir in der Offerte als Pauschale statt als Schätzung ausweisen."]]},
 {slug:"badsanierung-luzern",n:"Luzern",kt:"LU",region:"luzern",
  lead:"Komplette Badsanierung in Luzern und Umgebung — ein Ansprechpartner für Sanitär, Abdichtung und Platten, mit festem Übergabetermin.",
  titel:"Ein Weg, nicht zehn",
  absatz:"Luzern liegt rund fünfzig Minuten von unserem Lager entfernt, und das ändert die Planung. Wir arbeiten hier in zusammenhängenden Blöcken statt in vielen kurzen Besuchen und bestellen das Material vollständig, bevor der Rückbau beginnt — eine vergessene Armatur kostet in Luzern einen Tag, in Altstetten eine Stunde. Wer nur eine einzelne Kleinreparatur am Bad braucht, ist mit einem Betrieb vor Ort besser bedient; für die Vollsanierung kommen wir gerne.",
  faq:[["Kommen Sie für ein einzelnes Bad nach Luzern?","Für eine Vollsanierung ja, die Anfahrt ist im Festpreis. Für eine Reparatur unter drei Stunden empfehlen wir Ihnen einen Betrieb vor Ort."],["Wie verhindern Sie Verzögerungen wegen Material?","Wir bestellen komplett vor dem Rückbau und beginnen erst, wenn alles da ist."]]},
];
/* Ablauf einer Vollsanierung — die Schritte aus dem Referenzprojekt «Objektbad» (PROJECTS). */
const BAD_ABLAUF=[
 ["Rückbau bis auf den Rohbau","Alte Apparate, Platten und Unterkonstruktion raus, Schutt laufend entsorgt."],
 ["Neue Wasser- und Abwasserleitungen","Verlegt und mit Druck- und Dichtigkeitsprüfung geprüft. Das Protokoll geht an Sie."],
 ["Vorwandinstallation","WC, Spülkasten und Nischen in der Wand — Technik verschwindet, Stauraum kommt dazu."],
 ["Abdichtung im Verbund","Vor den Platten, fotografiert vor dem Schliessen. Ohne diesen Schritt ist eine bodenebene Dusche nicht dicht."],
 ["Platten und Fugen","Boden und Wände, grossformatig oder kleinteilig, nach Ihrer Materialwahl."],
 ["Montage und Abnahme","Armaturen, Spiegel, Beleuchtung, Reinigung — Übergabe per Abnahmeprotokoll."],
];
